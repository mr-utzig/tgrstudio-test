...
return [
    ...
    */
    ...
    'custom' => [
        'id' => [
            'required' => "Informe o ID do produto.",
            'exists' => 'Não foi encontrado um produto com esse ID.'
        ],
        'name' => [
            'required' => 'Informe o nome do produto.',
            'unique' => 'Já existe um produto cadastrado com esse nome.',
            'max' => 'O nome do produto deve conter no máximo 255 caracteres.'
        ],
        'price' => [
            'gt' => 'O preço deve ser um valor maior que zero.',
            'decimal' => 'O valor deve ser um decimal com até duas casas depois da vírgula.'
        ],
        'quantity' => [
            'gt' => 'A quantidade deve ser um valor maior que zero.'
        ]
    ],
